...
<?php
 ...
 if($_SESSION['nivel_usuario'] != 'Aluno' && $_SESSION['nivel_usuario'] != 'Administrador'){
				 ...
				 <li class="nav-item dropdown mr-3">
			        ...
			        <div class="dropdown-menu dropdown-menu-right dropdown-default"
			          ...
			          if($_SESSION['nivel_usuario'] == 'Administrador'){
						 	...
						 	?>
						 	 ...
						 	 <a class="dropdown-item" href="../painel-admin/painel_admin.php">Painél do Administrador</a>
			      ...
			      <?php 
				   ...
				   <li class="nav-item avatar mt-2">
				  	 <span class="text-muted "><a class="nome_usuario" href="painel_aluno.php?acao=perfil&cpf=<?php echo $_SESSION['cpf_usuario']; ?>"><?php echo $nome; ?> </a> </span>
		 ...
		 <!-- Sidebar -->
		    <div class="bg-light" id="sidebar-wrapper">
		      ...
		      <div class="list-group list-group-flush">
		      	 ...
		      	 <span href="#" class="list-group-item ativo">Painél Aluno</span>
		      	
		         <a href="painel_aluno.php?acao=perfil&cpf=<?php echo $_SESSION['cpf_usuario']; ?>" class="list-group-item list-group-item-action bg-light"><i class="fas fa-user-friends mr-1"></i>Editar Perfil</a>
